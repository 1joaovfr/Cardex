...
QLabel#StatusImprocedente {
    color: #f56565; font-weight: bold; background-color: #1b212d; border: 1px solid #c53030;
}
QLabel#StatusNeutro {
...
class PageAnalise(QWidget):
    def __init__(self):
        ...
        # Mock Database
        self.db_itens_pendentes = [
            {"id": "101", "nf": "55032", "cod": "P001", "desc": "Bomba de Combustível", "data": "25/11/2023"},
            {"id": "102", "nf": "55032", "cod": "P045", "desc": "Pastilha de Freio", "data": "25/11/2023"},
            {"id": "103", "nf": "55040", "cod": "EL99", "desc": "Alternador 12V", "data": "26/11/2023"},
        ]
        ...
        # =================================================================
        # PARTE 1: TABELA DE ITENS PENDENTES
        # =================================================================
        ...
        self.txt_desc_avaria = QLineEdit()
        self.txt_desc_avaria.setReadOnly(True)
        self.txt_desc_avaria.setPlaceholderText("Descrição da avaria...")
    ...
    def carregar_dados_tabela(self):
        ...
        for item in self.db_itens_pendentes:
            row = self.table.rowCount()
            self.table.insertRow(row)
            self.table.setItem(row, 0, QTableWidgetItem(item['id']))
            self.table.setItem(row, 1, QTableWidgetItem(item['nf']))
            self.table.setItem(row, 2, QTableWidgetItem(item['cod']))
            self.table.setItem(row, 3, QTableWidgetItem(item['desc']))
            self.table.setItem(row, 4, QTableWidgetItem(item['data']))
    ...
    def salvar_analise(self):
        ...
        print(f"Análise salva para o Item {self.item_atual}")
        print(f"Status: {self.lbl_status_resultado.text()}")
