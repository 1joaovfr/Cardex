...
class RelatorioModel:
    ...
    def get_dados_relatorio(self):
        """Busca os dados crus do banco para exibir na Tabela da View."""
        sql = """
            SELECT 
                l.status, 
                l.codigo_analise, 
                ...
                c.estado,
                c.regiao,
                to_char(n.data_nota, 'DD/MM/YYYY') as data_emissao, -- CAMPO NOVO (Emissão)
                ...
                l.valor_item,
                l.ressarcimento,
                -- Placeholders para Retorno (caso ainda não tenha implementado)
                NULL as nf_retorno,
